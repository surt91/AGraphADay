...
RUN apt-get update && apt-get install -y python3 python3-networkx python3-matplotlib python3-scipy python3-pygraphviz  python3-tweepy python3-fuzzywuzzy python3-cairo python3-gi imagemagick optipng gnupg git
